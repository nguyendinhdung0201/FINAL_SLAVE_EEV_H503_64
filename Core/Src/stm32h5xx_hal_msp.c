...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA3     ------> ADC1_INP15
    */
    GPIO_InitStruct.Pin = hoive_INP0_Pin|dauday_INP1_Pin|low_pressure_INP14_Pin|high_pressure_INP15_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA3     ------> ADC1_INP15
    */
    HAL_GPIO_DeInit(GPIOA, hoive_INP0_Pin|dauday_INP1_Pin|low_pressure_INP14_Pin|high_pressure_INP15_Pin);
